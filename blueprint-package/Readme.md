...
1. Copy the following folders to the specified locations in your webdav/template folder
	A. assets/js- Copy the loginradius folder to your webdav/template/js folder
	B. assets/images- Copy the loginradius folder to your webdav/template/images folder
	C. assets/css- Copy the loginradius folder to your webdav/template/Styles folder
